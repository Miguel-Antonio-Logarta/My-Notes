CREATE SCHEMA `db_thetradingpost`;

-- Create the users table
CREATE TABLE `db_thetradingpost`.`user` (
...
CREATE TABLE `db_thetradingpost`.`product` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Create Cart table
CREATE TABLE `db_thetradingpost`.`cart` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `db_thetradingpost`.`settings` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `db_thetradingpost`.`favorite` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `customer_id` INT NOT NULL,
  `product_id` INT NOT NULL,
...
-- Create Review table
CREATE TABLE `db_thetradingpost`.`review` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `product_id` INT NOT NULL,
  `customer_id` INT NOT NULL,
...
CREATE TABLE `db_thetradingpost`.`address` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `customer_id` INT NOT NULL,
...
-- Create orders table
CREATE TABLE `db_thetradingpost`.`order` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `db_thetradingpost`.`orderitem` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `db_thetradingpost`.`giftcard` (
  `id` INT NOT NULL,
...
-- Create Coupon table
CREATE TABLE `db_thetradingpost`.`coupon` (
  `id` INT NOT NULL,
...
CREATE TABLE `db_thetradingpost`.`paymentcard` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
